...
summary: " I built his project to demonstate my ability to fetch an API. I used Advice Lip API for this purpose and the result is an app the generates a new piece of advice everytime the dice is rolled.
"
image: /images/portfolio/random-advice-generator.png
imageAlt: "Random Advice Generator"
tech:
  - "Javascript"
siteUrl: "[#](https://philjg.github.io/advice-generator-app/)"
repoUrl: "[#](https://github.com/PhilJG/advice-generator-app)"
---
